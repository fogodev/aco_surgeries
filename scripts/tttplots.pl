...
##      ----------------------------------------------------------------
    ...
    if ($datafilethere == 0) {
        die "Error, data file missing. \nUsage : perl tttplots.pl -f datafile -o outputfile \n";
    }
    if ($outputfilethere == 0) {
        die "Error, output file missing. \nUsage (files with no extension): perl tttplots.pl -f datafile -o outputfile \n";
    }

##      ----------------------------------------------------------------
#    Name output files.
##      ----------------------------------------------------------------
    $emp_lin_filename = $outputfilename . "-el" . ".dat";
    $the_lin_filename = $outputfilename . "-tl" . ".dat";
    $up_lin_filename = $outputfilename . "-ul" . ".dat";
    $lo_lin_filename = $outputfilename . "-ll" . ".dat";
    $gpl_lin_filename = $outputfilename . "-qq" . ".gpl";
    $ps_lin_filename = $outputfilename . "-qq" . ".ps";
    $emp_exp_filename = $outputfilename . "-ee" . ".dat";
    $the_exp_filename = $outputfilename . "-te" . ".dat";
    $gpl_exp_filename = $outputfilename . "-exp" . ".gpl";
    $ps_exp_filename = $outputfilename . "-exp" . ".ps";
